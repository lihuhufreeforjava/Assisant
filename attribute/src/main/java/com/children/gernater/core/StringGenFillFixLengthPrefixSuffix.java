 ...
 */
public class StringGenFillFixLengthPrefixSuffix extends StringGenAbstract {
    private char[] arr;

    public StringGenFillFixLengthPrefixSuffix(int maxLength, char[] arr) {
        this.arr = arr;
        super.maxLength = maxLength;
    }

    public StringGenFillFixLengthPrefixSuffix(String[] prefix, int maxLength, char[] arr) {
        this.arr = arr;
        super.maxLength = maxLength;
        super.prifix = prefix;
    }
    public StringGenFillFixLengthPrefixSuffix(String[] prefix, String[] suffix,int maxLength, char[] arr) {
        this.arr = arr;
        super.maxLength = maxLength;
        super.prifix = prefix;
        super.suffix=suffix;
